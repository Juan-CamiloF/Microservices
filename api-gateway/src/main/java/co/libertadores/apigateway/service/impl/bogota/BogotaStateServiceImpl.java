...
@Service
@Qualifier("bogota")
public class BogotaStateServiceImpl implements IStateService {
    ...
    public BogotaStateServiceImpl(@Value("${bogota.state.service.url}") String serviceState, RestTemplate restTemplate) {
