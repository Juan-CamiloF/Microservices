...
@Service
@Qualifier("cali")
public class CaliStateServiceImpl implements IStateService {
    ...
    public CaliStateServiceImpl(@Value("${cali.state.service.url}") String serviceState, RestTemplate restTemplate) {
