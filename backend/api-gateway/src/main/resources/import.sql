...
--
--INSERT INTO states (name) VALUES ('ABIERTA') ON CONFLICT DO NOTHING;
--INSERT INTO states (name) VALUES ('EN PROGRESO') ON CONFLICT DO NOTHING;
--INSERT INTO states (name) VALUES ('PRUEBAS') ON CONFLICT DO NOTHING;
--INSERT INTO states (name) VALUES ('TERMINADO') ON CONFLICT DO NOTHING;
--INSERT INTO states (name) VALUES ('OTRO') ON CONFLICT DO NOTHING;
