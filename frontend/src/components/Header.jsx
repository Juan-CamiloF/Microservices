      ...
      <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
        ...
        <div className="flex justify-between ">
          <div className="hidden sm:flex flex-row items-center space-x-6">
            <a href="https://www.ulibertadores.edu.co/" target="_blank">
              <BsTwitter className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer w-6 h-6 dark:text-white" />
            </a>
            <a href="https://www.ulibertadores.edu.co/" target="_blank">
              <FaFacebook className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer w-6 h-6 dark:text-white" />
            </a>

            <a href="https://www.ulibertadores.edu.co/" target="_blank">
              <BsLinkedin className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer w-6 h-6 dark:text-white" />
            </a>
          </div>
          <div className=" flex space-x-3 items-center">
            <Link to="/">
              <h1 className=" font-mono text-2xl leading-6 text-gray-800 dark:text-white">
                Libertadores
              </h1>
            </Link>
          </div>
          <div className="hidden sm:flex flex-row space-x-4">
            <div className="flex items-center mb-4 lg:mb-0 mr-10">
              <div className="w-10 h-10 bg-cover  mr-3">
                <img
                  src="https://t3.ftcdn.net/jpg/03/58/90/78/360_F_358907879_Vdu96gF4XVhjCZxN2kCG0THTsSQi8IhT.jpg"
                  alt
                  className="rounded-lg h-full w-full overflow-hidden shadow"
                />
              </div>
